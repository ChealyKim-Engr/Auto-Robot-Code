...
void UART_Init(void){
  ...
  GPIO_PORTA_DEN_R |= 0x03;             // enable digital I/O on PA1-0
	...
	GPIO_PORTA_DIR_R &= ~0x20;            // make PA5 as input
	GPIO_PORTA_DIR_R |= 0x40;    				  // make PA6 as output
                                        // configure PA1-0 as UART
  GPIO_PORTA_PCTL_R = (GPIO_PORTA_PCTL_R&0xFFFFFF00)+0x00000011;
	GPIO_PORTA_PCTL_R &= ~0x0FF00000;     // configure PA5-6 as digital I/O
  GPIO_PORTA_AMSEL_R &= ~0x63;          // disable analog functionality on PA5-6, PA0-1
}
